...
class OrganizationRegistrationStep2 extends StatefulWidget {
  final Map<String, dynamic> registrationData;

  const OrganizationRegistrationStep2({
    Key? key,
    required this.registrationData,
  }) : super(key: key);

  @override
  State<OrganizationRegistrationStep2> createState() =>
      _OrganizationRegistrationStep2State();
}

class _OrganizationRegistrationStep2State
    extends State<OrganizationRegistrationStep2> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Step 2 of 2', style: AppTheme.bodySmall),
